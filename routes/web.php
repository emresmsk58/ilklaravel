...
Route::get("/book-update",[\App\Http\Controllers\Modeloperations::class,'bookupdate'])->name('books.book-update');
Route::get("/update/{id}",[\App\Http\Controllers\Modeloperations::class,'update'])->name('book.update');
